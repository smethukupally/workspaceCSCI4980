...
public class MyTableViewer {
   public final static String ID        = "project0920-add-delete-methukupally.partdescriptor.simpletableaddingdeleting";
   public final static String POPUPMENU = "project0920-add-delete-methukupally.popupmenu.addperson";
